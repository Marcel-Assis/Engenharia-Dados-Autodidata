...
arquivo = open("Python/10-Arquivos/nomes.txt", "wt") # Abrir o arquivo para escrita
...
arquivo = open("Python/10-Arquivos/nomes2.txt", "wt")
...
arquivo = open("Python/10-Arquivos/numeros3.txt", "wt")
...
with open("Python/10-Arquivos/exemplo2_with.txt", "wt") as arquivo: # Abrir o arquivo para escrita usando a declaração with
