...
arquivo = open("exemplo2_with.txt", "rt") # Abrir o arquivo para leitura
...
with open("exemplo2_with.txt", "rt") as arquivo: # Abrir o arquivo para leitura usando a declaração with
    conteudo = arquivo.read() # Ler o conteúdo do arquivo
    print(conteudo) # Imprimir o conteúdo do arquivo
...
with open("exemplo2_with.txt", "rt") as arquivo: # Abrir o arquivo para leitura
